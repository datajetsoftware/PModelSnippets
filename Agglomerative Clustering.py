...
#associatedData["cluster_centers"] = clustering.cluster_centers_.tolist()
#associatedData["plottableCentroids"] = clustering.cluster_centers_.tolist()

#associatedData["inertia"] = clustering.inertia_
...
associatedData["clustersFound"]=clustering.n_clusters
associatedData["leaves"]=clustering.n_leaves_
associatedData["features"]=clustering.n_features_in_
